import { OpenAi } from "../utils/sendToOpenAi.js";
...
class Editor {
    constructor() {
        ...
        this.username = ActionCookies.getCookie("username")
        this.password = ActionCookies.getCookie("password")
    ...
    newFile() {
        ...
        if (filename && !localStorage.getItem(filename)) {
            ...
            handleAction('savefile', this.username, this.password, filename, JSON.stringify([]));
    ...
    saveFile() {
        if (this.currentFile) {
            ...
            handleAction('updatefile', this.username, this.password, this.currentFile, JSON.stringify(cellContents))
        } else {
            this.saveFileAs();
        }
    }
    ...
    saveFileAs() {
        ...
        if (filename) {
            ...
            handleAction('updatefile', this.username, this.password, this.currentFile, this.cellsContainer.innerHTML)
            this.currentFile = filename;
